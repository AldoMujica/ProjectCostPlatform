...
Spec: [material-management-features.md](../material-management-features.md)
...
|-----------------------------------|-----------------------------------------------|-------|
| `MaterialCost` model              | [backend/models/MaterialCost.js](../backend/models/MaterialCost.js) | Partial — one flat row per material entry |
| `POST /api/costs/material`        | [backend/routes/costs.js](../backend/routes/costs.js) | Wired |
