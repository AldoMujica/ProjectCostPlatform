...
Spec: [labor-management-features.md](../labor-management-features.md)
...
|------------------------------|----------------------------------------------------|-------|
| `LaborCost` model            | [backend/models/LaborCost.js](../backend/models/LaborCost.js) | Present, no OT/regular split |
| `POST /api/costs/labor`      | [backend/routes/costs.js](../backend/routes/costs.js) | Wired |
