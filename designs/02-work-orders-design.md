...
Spec: [work-orders.md](../docs/modules/work-orders.md)
...
|----------------------------|--------------------------------------------|-------|
| `WorkOrder` Sequelize model | [backend/src/models/WorkOrder.js](../backend/src/models/WorkOrder.js) | Present, missing audit fields |
| CRUD routes                | [backend/src/routes/workOrders.js](../backend/src/routes/workOrders.js) | GET/POST/PUT/DELETE wired |
