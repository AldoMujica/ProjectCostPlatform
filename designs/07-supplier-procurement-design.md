...
Spec: [supplier-procurement.md](../docs/modules/supplier-procurement.md)
...
|----------------------------------|--------------------------------------------------|-------|
| `Supplier` model                 | [backend/src/models/Supplier.js](../backend/src/models/Supplier.js) | Present |
| CRUD routes                      | [backend/src/routes/suppliers.js](../backend/src/routes/suppliers.js) | GET/POST/PUT wired |
