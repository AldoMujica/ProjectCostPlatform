...
Spec: [dashboard-analytics-features.md](../dashboard-analytics-features.md)
...
| `/api/work-orders/kpi/summary`     | [backend/routes/workOrders.js](../backend/routes/workOrders.js) | Wired |
| `/api/quotes/kpi/open-count`       | [backend/routes/quotes.js](../backend/routes/quotes.js)         | Wired |
| `/api/costs/kpi/material-transit`  | [backend/routes/costs.js](../backend/routes/costs.js)           | Wired |
