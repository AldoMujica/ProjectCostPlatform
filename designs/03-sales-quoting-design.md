...
Spec: [sales-quoting.md](../docs/modules/sales-quoting.md)
...
|---------------------------------|-----------------------------------------------|-------|
| `Quote` Sequelize model         | [backend/src/models/Quote.js](../backend/src/models/Quote.js) | `quoteNumber, client, description, amount, currency, status, validUntil` — no versioning fields |
| CRUD routes                     | [backend/src/routes/quotes.js](../backend/src/routes/quotes.js) | GET/POST/PUT + `/kpi/open-count` wired |
