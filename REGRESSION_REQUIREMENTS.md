...
>
> **Prereq:** The architecture phase (see [`designs/README.md`](./designs/README.md) and [`IMPLEMENTATION_AUDIT.md`](./IMPLEMENTATION_AUDIT.md)) must be confirmed OK before executing the "Future" sections.
>
> **Scope split:**
...
| ID           | Scope | Assertion                                                                                  |
|--------------|:-----:|--------------------------------------------------------------------------------------------|
| AC-DASH-01 … 10 | UI | See [`dashboard-analytics-features.md`](./dashboard-analytics-features.md) §Acceptance criteria. |
...
| ID           | Scope | Assertion                                                                                     |
|--------------|:-----:|-----------------------------------------------------------------------------------------------|
| AC-OT-01 … 12 | UI + PDF | See [`work-order-management-features.md`](./work-order-management-features.md).            |
...
| ID          | Scope | Assertion                                                                                     |
|-------------|:-----:|-----------------------------------------------------------------------------------------------|
| AC-COT-01 … 10 | UI | See [`sales-quoting-features.md`](./sales-quoting-features.md).                                |
...
| ID          | Scope | Assertion                                                                          |
|-------------|:-----:|------------------------------------------------------------------------------------|
| AC-PRON-01 … 06 | UI | See [`cost-forecasting-features.md`](./cost-forecasting-features.md).             |
...
| ID          | Scope | Assertion                                                                           |
|-------------|:-----:|-------------------------------------------------------------------------------------|
| AC-MAT-01 … 06 | UI | See [`material-management-features.md`](./material-management-features.md).         |
...
| ID            | Scope | Assertion                                                                        |
|---------------|:-----:|----------------------------------------------------------------------------------|
| AC-ENT-01 … 53 | UI | See [`supplier-procurement-features.md`](./supplier-procurement-features.md).     |
...
| ID           | Scope | Assertion                                                                     |
|--------------|:-----:|-------------------------------------------------------------------------------|
| AC-HOR-01 … 07 | UI | See [`labor-management-features.md`](./labor-management-features.md).          |
...
| ID           | Scope | Assertion                                                                     |
|--------------|:-----:|-------------------------------------------------------------------------------|
| AC-NOM-01 … 08 | UI | See [`payroll-cfdi-features.md`](./payroll-cfdi-features.md).                  |
...
| ID              | Scope | Assertion                                                                     |
|-----------------|:-----:|-------------------------------------------------------------------------------|
| AC-CONC-01 … 54 | UI + Integration | See [`attendance-reconciliation-features.md`](./attendance-reconciliation-features.md). |
...
| ID          | Scope | Assertion                                                                      |
|-------------|:-----:|--------------------------------------------------------------------------------|
| AC-MO-01 … 05 | UI  | See [`labor-management-features.md`](./labor-management-features.md).           |
...
| ID          | Scope | Assertion                                                                   |
|-------------|:-----:|-----------------------------------------------------------------------------|
| AC-REP-01 … 06 | UI | OT PDF export — see [`reporting-export-features.md`](./reporting-export-features.md). |
...
"Now" = author and execute in Phase 2 kickoff. "Future" = blocked on architecture & gap closures from [`IMPLEMENTATION_AUDIT.md`](./IMPLEMENTATION_AUDIT.md).
