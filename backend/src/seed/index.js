  ...
  await Quote.bulkCreate([
    {
      ...
      cotRefAlenstec: 'CZ-2026-001',
      client: 'Adient Lerma',
      cliente: 'Adient Lerma',
      description: 'Cotización para refurbish de componentes',
      descripcionProyecto: 'Refurbish de componentes diversos',
      amount: 15000,
      costoCotUsd: 15000,
      currency: 'USD',
      status: 'Pendiente',
      validUntil: new Date('2026-05-01'),
      fechaCot: new Date('2026-04-23'),
      tipo: 'Refurbish',
      tipoContrato: 'Abierta',
      tipoCambio: 17.34,
    },
    {
      quoteNumber: 'CZ-2026-002',
      cotRefAlenstec: 'CZ-2026-002',
      client: 'Autoliv AMX',
      cliente: 'Autoliv AMX',
      description: 'Fabricación de piezas personalizadas',
      descripcionProyecto: 'Fabricación de piezas personalizadas para Autoliv',
      amount: 22000,
      costoCotUsd: 22000,
      currency: 'USD',
      status: 'Pendiente',
    ...
    },
    {
      ...
      cotRefAlenstec: 'CZ-2026-003',
      client: 'Avanzar',
      cliente: 'Avanzar',
      description: 'Servicios de corte y ensamble',
      descripcionProyecto: 'Servicios de corte láser y ensamble',
      amount: 18750,
      costoCotUsd: 18750,
      currency: 'USD',
      status: 'Aprobada',
    ...
    },
    {
      ...
      cotRefAlenstec: 'CZ-2026-004',
      client: 'Mayser',
      cliente: 'Mayser',
      description: 'Suministro de componentes eléctricos',
      descripcionProyecto: 'Suministro de componentes eléctricos variados',
      amount: 9200,
      costoCotUsd: 9200,
      currency: 'USD',
      status: 'Pendiente',
